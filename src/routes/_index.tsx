...
import { readFile } from '../server/effects/fs/read-file.effect';
  ...
  Effect.withSpan('index-loader', {
    ...
    Effect.gen(function* () {
      return yield* Effect.all(
        [
          readFile('./src/server/effects/loader/effect-loader.ts'),
          readFile('./src/server/effects/loader/logic/remix-throw.ts'),
          readFile('./src/code-samples/route-loader.code-sample.ts'),
          readFile('./src/code-samples/useErrorDetails.code-sample.ts'),
          readFile('./src/code-samples/error-boundary.code-sample.tsx'),
        ],
  ...
  return (
    <div className="flex flex-col md:mx-0">
      ...
      <div className="my-2 flex flex-col gap-2">
        <Code title="Effect loader" code={loaderCode} className="self-center" />
        <Code
          title="Remix throw"
          code={remixThrowCode}
